Event.Common = class {
    static attachEvents = function() {
        let heading = window.document.body.querySelector('[rel="js-heading"]');
        let headingItems = heading.querySelectorAll('li');
        for (let i = 0; i < headingItems.length; i++) {
            headingItems[i].addEventListener('click', function() {
                let forward = headingItems[i].dataset.forward;
